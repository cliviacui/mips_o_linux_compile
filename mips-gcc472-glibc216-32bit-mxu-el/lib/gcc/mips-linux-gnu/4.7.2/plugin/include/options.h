...
#define MASK_MCU (1 << 19)
#define MASK_MEMCPY (1 << 20)
#define MASK_MICROMIPS (1 << 21)
#define MASK_OCTEON_UNALIGNED (1 << 22)
#define MASK_PAIRED_SINGLE_FLOAT (1 << 23)
#define MASK_RELAX_PIC_CALLS (1 << 24)
#define MASK_SINGLE_FLOAT (1 << 25)
#define MASK_SMARTMIPS (1 << 26)
#define MASK_SOFT_FLOAT_ABI (1 << 27)
...
enum opt_code
{
  ...
  OPT_Wpoison_system_directories = 306,      /* -Wpoison-system-directories */
  OPT_Wpragmas = 307,                        /* -Wpragmas */
  OPT_Wproperty_assign_default = 308,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 309,                       /* -Wprotocol */
  OPT_Wpsabi = 310,                          /* -Wpsabi */
  OPT_Wraw = 311,                            /* -Wraw */
  OPT_Wreal_q_constant = 312,                /* -Wreal-q-constant */
  OPT_Wredundant_decls = 313,                /* -Wredundant-decls */
  OPT_Wredundant_modifiers = 314,            /* -Wredundant-modifiers */
  OPT_Wreorder = 315,                        /* -Wreorder */
  OPT_Wreturn_type = 316,                    /* -Wreturn-type */
  OPT_Wselector = 317,                       /* -Wselector */
  OPT_Wsequence_point = 318,                 /* -Wsequence-point */
  OPT_Wserial = 319,                         /* -Wserial */
  OPT_Wshadow = 320,                         /* -Wshadow */
  OPT_Wsign_compare = 321,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 322,                /* -Wsign-conversion */
  OPT_Wsign_promo = 323,                     /* -Wsign-promo */
  OPT_Wspecial_param_hiding = 324,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 325,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 326,                   /* -Wstack-usage= */
  OPT_Wstatic_access = 327,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 328,                /* -Wstatic-receiver */
  OPT_Wstrict_aliasing = 329,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 330,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 331,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 332,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 333,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 334,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 335,          /* -Wstrict-selector-match */
  OPT_Wsuggest_attribute_const = 336,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_noreturn = 337,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 338,         /* -Wsuggest-attribute=pure */
  OPT_Wsuppress = 339,                       /* -Wsuppress */
  OPT_Wsurprising = 340,                     /* -Wsurprising */
  OPT_Wswitch = 341,                         /* -Wswitch */
  OPT_Wswitch_default = 342,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 343,                    /* -Wswitch-enum */
  OPT_Wsync_nand = 344,                      /* -Wsync-nand */
  OPT_Wsynth = 345,                          /* -Wsynth */
  OPT_Wsynthetic_access = 346,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 347,                 /* -Wsystem-headers */
  OPT_Wtabs = 348,                           /* -Wtabs */
  OPT_Wtasks = 349,                          /* -Wtasks */
  OPT_Wtraditional = 350,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 351,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 352,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 353,                      /* -Wtrigraphs */
  OPT_Wtype_hiding = 354,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 355,                    /* -Wtype-limits */
  OPT_Wuncheck = 356,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 357,            /* -Wundeclared-selector */
  OPT_Wundef = 358,                          /* -Wundef */
  OPT_Wunderflow = 359,                      /* -Wunderflow */
  OPT_Wuninitialized = 360,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 361,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 362,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 363,              /* -Wunqualified-field */
  /* OPT_Wunreachable_code = 364, */         /* -Wunreachable-code */
  OPT_Wunsafe_loop_optimizations = 365,      /* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 366,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 367,                         /* -Wunused */
  OPT_Wunused_argument = 368,                /* -Wunused-argument */
  OPT_Wunused_but_set_parameter = 369,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 370,        /* -Wunused-but-set-variable */
  OPT_Wunused_dummy_argument = 371,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 372,                /* -Wunused-function */
  OPT_Wunused_import = 373,                  /* -Wunused-import */
  OPT_Wunused_label = 374,                   /* -Wunused-label */
  OPT_Wunused_local = 375,                   /* -Wunused-local */
  OPT_Wunused_local_typedefs = 376,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 377,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 378,               /* -Wunused-parameter */
  OPT_Wunused_private = 379,                 /* -Wunused-private */
  OPT_Wunused_result = 380,                  /* -Wunused-result */
  OPT_Wunused_thrown = 381,                  /* -Wunused-thrown */
  OPT_Wunused_value = 382,                   /* -Wunused-value */
  OPT_Wunused_variable = 383,                /* -Wunused-variable */
  OPT_Wuseless_type_check = 384,             /* -Wuseless-type-check */
  OPT_Wvarargs_cast = 385,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 386,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 387,   /* -Wvector-operation-performance */
  OPT_Wvla = 388,                            /* -Wvla */
  OPT_Wvolatile_register_var = 389,          /* -Wvolatile-register-var */
  OPT_Wwarning_token = 390,                  /* -Wwarning-token */
  OPT_Wwrite_strings = 391,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 392,  /* -Wzero-as-null-pointer-constant */
  ...
  OPT_c = 403,                               /* -c */
  /* OPT_classpath = 404, */                 /* -classpath */
  OPT_coverage = 405,                        /* -coverage */
  OPT_cpp = 406,                             /* -cpp */
  OPT_cpp_ = 407,                            /* -cpp= */
  OPT_d = 408,                               /* -d */
  OPT_dumpbase = 409,                        /* -dumpbase */
  OPT_dumpdir = 410,                         /* -dumpdir */
  OPT_dumpmachine = 411,                     /* -dumpmachine */
  OPT_dumpspecs = 412,                       /* -dumpspecs */
  OPT_dumpversion = 413,                     /* -dumpversion */
  OPT_e = 414,                               /* -e */
  /* OPT_encoding = 415, */                  /* -encoding */
  OPT_export_dynamic = 416,                  /* -export-dynamic */
  OPT_extdirs = 417,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 418, */               /* -fCLASSPATH= */
  OPT_fPIC = 419,                            /* -fPIC */
  OPT_fPIE = 420,                            /* -fPIE */
  OPT_fRTS_ = 421,                           /* -fRTS= */
  OPT_fabi_version_ = 422,                   /* -fabi-version= */
  OPT_faccess_control = 423,                 /* -faccess-control */
  OPT_faggressive_function_elimination = 424,/* -faggressive-function-elimination */
  ...
  OPT_fallow_parameterless_variadic_functions = 437,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 438, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 439, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 440, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 441, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 442, */  /* -fargument-noalias-global */
  OPT_fasm = 443,                            /* -fasm */
  OPT_fassert = 444,                         /* -fassert */
  OPT_fassociative_math = 445,               /* -fassociative-math */
  OPT_fassume_compiled = 446,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 447,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 448,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 449,                   /* -fauto-inc-dec */
  OPT_fautomatic = 450,                      /* -fautomatic */
  OPT_faux_classpath = 451,                  /* -faux-classpath */
  OPT_fbackslash = 452,                      /* -fbackslash */
  OPT_fbacktrace = 453,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 454,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 455,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 456,              /* -fbootstrap-classes */
  OPT_fbounds_check = 457,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 458,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 459,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 460,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 461,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 462,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 463,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 464,                        /* -fbuiltin */
  OPT_fbuiltin_ = 465,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 466,                    /* -fcall-saved- */
  OPT_fcall_used_ = 467,                     /* -fcall-used- */
  OPT_fcaller_saves = 468,                   /* -fcaller-saves */
  OPT_fcheck_array_temporaries = 469,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 470,                /* -fcheck-data-deps */
  OPT_fcheck_new = 471,                      /* -fcheck-new */
  OPT_fcheck_references = 472,               /* -fcheck-references */
  OPT_fcheck_ = 473,                         /* -fcheck= */
  OPT_fclasspath_ = 474,                     /* -fclasspath= */
  ...
  OPT_fdce = 504,                            /* -fdce */
  OPT_fdebug_cpp = 505,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 506,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 507,            /* -fdebug-types-section */
  OPT_fdeduce_init_list = 508,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 509,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 510, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 511,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 512,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 513,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 514,                 /* -fdelayed-branch */
  OPT_fdelete_null_pointer_checks = 515,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 516,                   /* -fdevirtualize */
  OPT_fdiagnostics_show_location_ = 517,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 518,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 519,                /* -fdirectives-only */
  OPT_fdisable_ = 520,                       /* -fdisable- */
  OPT_fdisable_assertions = 521,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 522,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 523,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 524,         /* -fdollars-in-identifiers */
  OPT_fdse = 525,                            /* -fdse */
  OPT_fdump_ = 526,                          /* -fdump- */
  /* OPT_fdump_core = 527, */                /* -fdump-core */
  OPT_fdump_final_insns = 528,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 529,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 530,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 531,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 532,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 533,                    /* -fdump-noaddr */
  OPT_fdump_parse_tree = 534,                /* -fdump-parse-tree */
  OPT_fdump_passes = 535,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 536,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 537,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 538,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 539,                 /* -fearly-inlining */
  OPT_feglibc_ = 540,                        /* -feglibc= */
  ...
  OPT_fencoding_ = 554,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 555,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 556, */           /* -fenum-int-equiv */
  OPT_fexceptions = 557,                     /* -fexceptions */
  OPT_fexcess_precision_ = 558,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 559,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 560,        /* -fexpensive-optimizations */
  OPT_fextdirs_ = 561,                       /* -fextdirs= */
  OPT_fextended_identifiers = 562,           /* -fextended-identifiers */
  OPT_fextension_elimination = 563,          /* -fextension-elimination */
  OPT_fexternal_blas = 564,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 565, */       /* -fexternal-templates */
  OPT_ff2c = 566,                            /* -ff2c */
  OPT_ffast_math = 567,                      /* -ffast-math */
  OPT_ffat_lto_objects = 568,                /* -ffat-lto-objects */
  OPT_ffeature_proxy = 569,                  /* -ffeature-proxy */
  OPT_ffilelist_file = 570,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 571,               /* -ffinite-math-only */
  OPT_ffixed_ = 572,                         /* -ffixed- */
  OPT_ffixed_form = 573,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 574,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 575,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 576,                    /* -ffloat-store */
  OPT_ffor_scope = 577,                      /* -ffor-scope */
  /* OPT_fforce_addr = 578, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 579,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 580,              /* -fforward-propagate */
  OPT_ffp_contract_ = 581,                   /* -ffp-contract= */
  OPT_ffpe_trap_ = 582,                      /* -ffpe-trap= */
  OPT_ffree_form = 583,                      /* -ffree-form */
  OPT_ffree_line_length_ = 584,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 585,          /* -ffree-line-length-none */
  OPT_ffreestanding = 586,                   /* -ffreestanding */
  OPT_ffriend_injection = 587,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 588,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 589,                   /* -ffunction-cse */
  OPT_ffunction_sections = 590,              /* -ffunction-sections */
  OPT_fgcse = 591,                           /* -fgcse */
  OPT_fgcse_after_reload = 592,              /* -fgcse-after-reload */
  OPT_fgcse_las = 593,                       /* -fgcse-las */
  OPT_fgcse_lm = 594,                        /* -fgcse-lm */
  OPT_fgcse_sm = 595,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 596,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 597,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 598,                         /* -fgnu-tm */
  OPT_fgnu89_inline = 599,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 600,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 601,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 602,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 603,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 604,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 605,                     /* -fgo-prefix= */
  OPT_fgraphite = 606,                       /* -fgraphite */
  OPT_fgraphite_identity = 607,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 608,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 609, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 610, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 611,           /* -fhash-synchronization */
  /* OPT_fhelp = 612, */                     /* -fhelp */
  /* OPT_fhelp_ = 613, */                    /* -fhelp= */
  /* OPT_fhonor_std = 614, */                /* -fhonor-std */
  OPT_fhosted = 615,                         /* -fhosted */
  /* OPT_fhuge_objects = 616, */             /* -fhuge-objects */
  OPT_fident = 617,                          /* -fident */
  OPT_fif_conversion = 618,                  /* -fif-conversion */
  OPT_fif_conversion2 = 619,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 620,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 621,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 622,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 623,             /* -fimplicit-templates */
  OPT_findirect_classes = 624,               /* -findirect-classes */
  OPT_findirect_dispatch = 625,              /* -findirect-dispatch */
  OPT_findirect_inlining = 626,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 627,         /* -finhibit-size-directive */
  OPT_finit_character_ = 628,                /* -finit-character= */
  OPT_finit_integer_ = 629,                  /* -finit-integer= */
  OPT_finit_local_zero = 630,                /* -finit-local-zero */
  OPT_finit_logical_ = 631,                  /* -finit-logical= */
  OPT_finit_real_ = 632,                     /* -finit-real= */
  OPT_finline = 633,                         /* -finline */
  OPT_finline_atomics = 634,                 /* -finline-atomics */
  OPT_finline_functions = 635,               /* -finline-functions */
  OPT_finline_functions_called_once = 636,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 637, */            /* -finline-limit- */
  OPT_finline_limit_ = 638,                  /* -finline-limit= */
  OPT_finline_small_functions = 639,         /* -finline-small-functions */
  OPT_finput_charset_ = 640,                 /* -finput-charset= */
  OPT_finstrument_function_calls = 641,      /* -finstrument-function-calls */
  OPT_finstrument_functions = 642,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 643,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 644,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 645,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 646,         /* -fintrinsic-modules-path */
  OPT_fipa_cp = 647,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 648,                   /* -fipa-cp-clone */
  OPT_fipa_matrix_reorg = 649,               /* -fipa-matrix-reorg */
  OPT_fipa_profile = 650,                    /* -fipa-profile */
  OPT_fipa_pta = 651,                        /* -fipa-pta */
  OPT_fipa_pure_const = 652,                 /* -fipa-pure-const */
  OPT_fipa_reference = 653,                  /* -fipa-reference */
  OPT_fipa_sra = 654,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 655, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 656,                 /* -fira-algorithm= */
  OPT_fira_loop_pressure = 657,              /* -fira-loop-pressure */
  OPT_fira_region_ = 658,                    /* -fira-region= */
  OPT_fira_share_save_slots = 659,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 660,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 661,                   /* -fira-verbose= */
  OPT_fivopts = 662,                         /* -fivopts */
  OPT_fjni = 663,                            /* -fjni */
  OPT_fjump_tables = 664,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 665,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 666,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 667,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 668, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 669,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 670,             /* -fleading-underscore */
  OPT_flicense_me = 671,                     /* -flicense-me */
  OPT_floop_block = 672,                     /* -floop-block */
  OPT_floop_flatten = 673,                   /* -floop-flatten */
  OPT_floop_interchange = 674,               /* -floop-interchange */
  /* OPT_floop_optimize = 675, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 676,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 677,                /* -floop-strip-mine */
  OPT_flto = 678,                            /* -flto */
  OPT_flto_compression_level_ = 679,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 680,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 681,         /* -flto-partition=balanced */
  OPT_flto_partition_none = 682,             /* -flto-partition=none */
  OPT_flto_report = 683,                     /* -flto-report */
  OPT_flto_ = 684,                           /* -flto= */
  OPT_fltrans = 685,                         /* -fltrans */
  OPT_fltrans_output_list_ = 686,            /* -fltrans-output-list= */
  OPT_fmain_ = 687,                          /* -fmain= */
  OPT_fmath_errno = 688,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 689,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 690,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 691,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 692,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 693,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 694,                     /* -fmem-report */
  OPT_fmerge_all_constants = 695,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 696,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 697,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 698,                /* -fmessage-length= */
  OPT_fmodule_private = 699,                 /* -fmodule-private */
  OPT_fmodulo_sched = 700,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 701,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 702,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 703,                  /* -fms-extensions */
  OPT_fmudflap = 704,                        /* -fmudflap */
  OPT_fmudflapir = 705,                      /* -fmudflapir */
  OPT_fmudflapth = 706,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 707, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 708, */                  /* -fnew-abi */
  OPT_fnext_runtime = 709,                   /* -fnext-runtime */
  OPT_fnil_receivers = 710,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 711,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 712,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 713, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 714,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 715,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 716,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 717,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 718,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 719,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 720,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 721,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 722,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 723,             /* -fomit-frame-pointer */
  OPT_fopenmp = 724,                         /* -fopenmp */
  OPT_foperator_names = 725,                 /* -foperator-names */
  OPT_foptimize_register_move = 726,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 727,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 728,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 729,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 730, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 731,              /* -foutput-class-dir= */
  OPT_fpack_derived = 732,                   /* -fpack-derived */
  OPT_fpack_struct = 733,                    /* -fpack-struct */
  OPT_fpack_struct_ = 734,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 735,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 736,              /* -fpcc-struct-return */
  OPT_fpch_deps = 737,                       /* -fpch-deps */
  OPT_fpch_preprocess = 738,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 739,                     /* -fpeel-loops */
  OPT_fpeephole = 740,                       /* -fpeephole */
  OPT_fpeephole2 = 741,                      /* -fpeephole2 */
  OPT_fpermissive = 742,                     /* -fpermissive */
  OPT_fpic = 743,                            /* -fpic */
  OPT_fpie = 744,                            /* -fpie */
  OPT_fplan9_extensions = 745,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 746,                    /* -fplugin-arg- */
  OPT_fplugin_ = 747,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 748,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 749,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 750,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 751,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 752,                   /* -fpreprocessed */
  OPT_fpretty_templates = 753,               /* -fpretty-templates */
  OPT_fprofile = 754,                        /* -fprofile */
  OPT_fprofile_arcs = 755,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 756,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 757,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 758,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 759,              /* -fprofile-generate= */
  OPT_fprofile_use = 760,                    /* -fprofile-use */
  OPT_fprofile_use_ = 761,                   /* -fprofile-use= */
  OPT_fprofile_values = 762,                 /* -fprofile-values */
  OPT_fpromote_loop_indices = 763,           /* -fpromote-loop-indices */
  OPT_fprotect_parens = 764,                 /* -fprotect-parens */
  OPT_frandom_seed = 765,                    /* -frandom-seed */
  OPT_frandom_seed_ = 766,                   /* -frandom-seed= */
  OPT_frange_check = 767,                    /* -frange-check */
  OPT_freal_4_real_10 = 768,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 769,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 770,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 771,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 772,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 773,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 774,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 775,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 776,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 777,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 778,                /* -frecord-marker=8 */
  OPT_frecursive = 779,                      /* -frecursive */
  OPT_freduced_reflection = 780,             /* -freduced-reflection */
  OPT_free = 781,                            /* -free */
  OPT_freg_struct_return = 782,              /* -freg-struct-return */
  OPT_fregmove = 783,                        /* -fregmove */
  OPT_fremove_local_statics = 784,           /* -fremove-local-statics */
  OPT_frename_registers = 785,               /* -frename-registers */
  OPT_freorder_blocks = 786,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 787,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 788,              /* -freorder-functions */
  OPT_frepack_arrays = 789,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 790,           /* -freplace-objc-classes */
  OPT_frepo = 791,                           /* -frepo */
  OPT_frequire_return_statement = 792,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 793,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 794, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 795,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 796,                    /* -fresolution= */
  OPT_frounding_math = 797,                  /* -frounding-math */
  OPT_frtti = 798,                           /* -frtti */
  OPT_fsaw_java_file = 799,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 800,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 801,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 802,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 803,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 804,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 805,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 806,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 807,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 808,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 809,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 810,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 811,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 812,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 813,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 814,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 815,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 816,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 817, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 818,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 819,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 820,              /* -fsecond-underscore */
  OPT_fsection_anchors = 821,                /* -fsection-anchors */
  /* OPT_fsee = 822, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 823,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 824,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 825, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 826,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 827,          /* -fselective-scheduling2 */
  OPT_fshort_double = 828,                   /* -fshort-double */
  OPT_fshort_enums = 829,                    /* -fshort-enums */
  OPT_fshort_wchar = 830,                    /* -fshort-wchar */
  OPT_fshow_column = 831,                    /* -fshow-column */
  OPT_fshrink_wrap = 832,                    /* -fshrink-wrap */
  OPT_fsign_zero = 833,                      /* -fsign-zero */
  OPT_fsignaling_nans = 834,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 835,               /* -fsigned-bitfields */
  OPT_fsigned_char = 836,                    /* -fsigned-char */
  OPT_fsigned_zeros = 837,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 838,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 839,               /* -fsource-filename= */
  OPT_fsource_ = 840,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 841,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 842,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 843,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 844, */                 /* -fsquangle */
  OPT_fstack_arrays = 845,                   /* -fstack-arrays */
  /* OPT_fstack_check = 846, */              /* -fstack-check */
  OPT_fstack_check_ = 847,                   /* -fstack-check= */
  OPT_fstack_limit = 848,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 849,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 850,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 851,                /* -fstack-protector */
  OPT_fstack_protector_all = 852,            /* -fstack-protector-all */
  OPT_fstack_usage = 853,                    /* -fstack-usage */
  OPT_fstats = 854,                          /* -fstats */
  OPT_fstore_check = 855,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 856, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 857,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 858,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 859,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 860, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 861,      /* -fstrict-volatile-bitfields */
  OPT_fsyntax_only = 862,                    /* -fsyntax-only */
  OPT_ftabstop_ = 863,                       /* -ftabstop= */
  /* OPT_ftarget_help = 864, */              /* -ftarget-help */
  OPT_ftarget_ = 865,                        /* -ftarget= */
  /* OPT_ftemplate_depth_ = 866, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 867,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 868,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 869, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 870,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 871,             /* -fthreadsafe-statics */
  OPT_ftime_report = 872,                    /* -ftime-report */
  OPT_ftls_model_ = 873,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 874,               /* -ftoplevel-reorder */
  OPT_ftracer = 875,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 876,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 877,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 878,                  /* -ftrapping-math */
  OPT_ftrapv = 879,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 880,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 881,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 882,                       /* -ftree-ccp */
  OPT_ftree_ch = 883,                        /* -ftree-ch */
  OPT_ftree_copy_prop = 884,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 885,                /* -ftree-copyrename */
  OPT_ftree_cselim = 886,                    /* -ftree-cselim */
  OPT_ftree_dce = 887,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 888,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 889,                       /* -ftree-dse */
  OPT_ftree_forwprop = 890,                  /* -ftree-forwprop */
  OPT_ftree_fre = 891,                       /* -ftree-fre */
  OPT_ftree_if_to_switch_conversion = 892,   /* -ftree-if-to-switch-conversion */
  OPT_ftree_loop_distribute_patterns = 893,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 894,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 895,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 896,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 897,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 898,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 899, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 900,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 901,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 902,        /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 903,               /* -ftree-partial-pre */
  ...
  OPT_ftree_tail_merge = 916,                /* -ftree-tail-merge */
  OPT_ftree_ter = 917,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 918,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 919,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 920,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 921,                       /* -ftree-vrp */
  OPT_funderscoring = 922,                   /* -funderscoring */
  OPT_funit_at_a_time = 923,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 924,               /* -funroll-all-loops */
  OPT_funroll_loops = 925,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 926,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 927,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 928,             /* -funsigned-bitfields */
  OPT_funsigned_char = 929,                  /* -funsigned-char */
  OPT_funswitch_loops = 930,                 /* -funswitch-loops */
  OPT_funwind_tables = 931,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 932,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 933,                   /* -fuse-boehm-gc */
  OPT_fuse_caller_save = 934,                /* -fuse-caller-save */
  OPT_fuse_cxa_atexit = 935,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 936,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 937,          /* -fuse-divide-subroutine */
  OPT_fuse_linker_plugin = 938,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 939,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 940,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 941,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 942,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 943, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 944,                /* -fvect-cost-model */
  OPT_fverbose_asm = 945,                    /* -fverbose-asm */
  /* OPT_fversion = 946, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 947,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 948,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 949,                    /* -fvisibility= */
  OPT_fvpt = 950,                            /* -fvpt */
  /* OPT_fvtable_gc = 951, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 952, */            /* -fvtable-thunks */
  OPT_fweak = 953,                           /* -fweak */
  OPT_fweb = 954,                            /* -fweb */
  OPT_fwhole_file = 955,                     /* -fwhole-file */
  OPT_fwhole_program = 956,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 957,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 958,              /* -fworking-directory */
  OPT_fwpa = 959,                            /* -fwpa */
  OPT_fwrapv = 960,                          /* -fwrapv */
  /* OPT_fxref = 961, */                     /* -fxref */
  /* OPT_fzee = 962, */                      /* -fzee */
  OPT_fzero_initialized_in_bss = 963,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 964,                      /* -fzero-link */
  OPT_g = 965,                               /* -g */
  OPT_gant = 966,                            /* -gant */
  OPT_gcoff = 967,                           /* -gcoff */
  OPT_gdwarf_ = 968,                         /* -gdwarf- */
  OPT_gen_decls = 969,                       /* -gen-decls */
  OPT_ggdb = 970,                            /* -ggdb */
  OPT_gnat = 971,                            /* -gnat */
  OPT_gnatO = 972,                           /* -gnatO */
  OPT_gno_record_gcc_switches = 973,         /* -gno-record-gcc-switches */
  OPT_gno_strict_dwarf = 974,                /* -gno-strict-dwarf */
  OPT_grecord_gcc_switches = 975,            /* -grecord-gcc-switches */
  OPT_gstabs = 976,                          /* -gstabs */
  OPT_gstabs_ = 977,                         /* -gstabs+ */
  OPT_gstrict_dwarf = 978,                   /* -gstrict-dwarf */
  OPT_gtoggle = 979,                         /* -gtoggle */
  OPT_gvms = 980,                            /* -gvms */
  OPT_gxcoff = 981,                          /* -gxcoff */
  OPT_gxcoff_ = 982,                         /* -gxcoff+ */
  OPT_h = 983,                               /* -h */
  OPT_idirafter = 984,                       /* -idirafter */
  OPT_imacros = 985,                         /* -imacros */
  OPT_imultilib = 986,                       /* -imultilib */
  OPT_include = 987,                         /* -include */
  OPT_iplugindir_ = 988,                     /* -iplugindir= */
  OPT_iprefix = 989,                         /* -iprefix */
  OPT_iquote = 990,                          /* -iquote */
  OPT_isysroot = 991,                        /* -isysroot */
  OPT_isystem = 992,                         /* -isystem */
  OPT_iwithprefix = 993,                     /* -iwithprefix */
  OPT_iwithprefixbefore = 994,               /* -iwithprefixbefore */
  OPT_k8 = 995,                              /* -k8 */
  OPT_l = 996,                               /* -l */
  OPT_lang_asm = 997,                        /* -lang-asm */
  OPT_mabi_ = 998,                           /* -mabi= */
  OPT_mabicalls = 999,                       /* -mabicalls */
  OPT_mad = 1000,                            /* -mad */
  OPT_mandroid = 1001,                       /* -mandroid */
  OPT_march_ = 1002,                         /* -march= */
  OPT_mbionic = 1003,                        /* -mbionic */
  OPT_mbranch_cost_ = 1004,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1005,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1006,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1007,                /* -mcode-readable= */
  OPT_mcompact_eh = 1008,                    /* -mcompact-eh */
  OPT_mdebug = 1009,                         /* -mdebug */
  OPT_mdebugd = 1010,                        /* -mdebugd */
  OPT_mdivide_breaks = 1011,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1012,                  /* -mdivide-traps */
  OPT_mdmx = 1013,                           /* -mdmx */
  OPT_mdouble_float = 1014,                  /* -mdouble-float */
  OPT_mdsp = 1015,                           /* -mdsp */
  OPT_mdspr2 = 1016,                         /* -mdspr2 */
  OPT_meb = 1017,                            /* -meb */
  OPT_mel = 1018,                            /* -mel */
  OPT_membedded_data = 1019,                 /* -membedded-data */
  OPT_meva = 1020,                           /* -meva */
  OPT_mexplicit_relocs = 1021,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1022,                  /* -mextern-sdata */
  OPT_mfix_24k = 1023,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1024,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1025,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1026,                     /* -mfix-r4400 */
  OPT_mfix_sb1 = 1027,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1028,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1029,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1030,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1031,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1032,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1033,                 /* -mfp-exceptions */
  OPT_mfp32 = 1034,                          /* -mfp32 */
  OPT_mfp64 = 1035,                          /* -mfp64 */
  OPT_mframe_header_opt = 1036,              /* -mframe-header-opt */
  OPT_mfused_madd = 1037,                    /* -mfused-madd */
  OPT_mglibc = 1038,                         /* -mglibc */
  OPT_mgp32 = 1039,                          /* -mgp32 */
  OPT_mgp64 = 1040,                          /* -mgp64 */
  OPT_mgpopt = 1041,                         /* -mgpopt */
  OPT_mhard_float = 1042,                    /* -mhard-float */
  OPT_minterlink_mips16 = 1043,              /* -minterlink-mips16 */
  OPT_mips = 1044,                           /* -mips */
  OPT_mips16 = 1045,                         /* -mips16 */
  OPT_mips16e = 1046,                        /* -mips16e */
  OPT_mips3d = 1047,                         /* -mips3d */
  OPT_mjals = 1048,                          /* -mjals */
  OPT_mllsc = 1049,                          /* -mllsc */
  OPT_mlocal_sdata = 1050,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1051,                    /* -mlong-calls */
  OPT_mlong32 = 1052,                        /* -mlong32 */
  OPT_mlong64 = 1053,                        /* -mlong64 */
  OPT_mmcount_ra_address = 1054,             /* -mmcount-ra-address */
  OPT_mmcu = 1055,                           /* -mmcu */
  OPT_mmemcpy = 1056,                        /* -mmemcpy */
  OPT_mmicromips = 1057,                     /* -mmicromips */
  OPT_mmt = 1058,                            /* -mmt */
  OPT_mno_float = 1059,                      /* -mno-float */
  OPT_mno_flush_func = 1060,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1061,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1062,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1063,                     /* -mno-mips3d */
  OPT_mocteon_useun = 1064,                  /* -mocteon-useun */
  OPT_mpaired_single = 1065,                 /* -mpaired-single */
  OPT_mplt = 1066,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1067,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1068,               /* -mrelax-pic-calls */
  OPT_mshared = 1069,                        /* -mshared */
  OPT_msingle_float = 1070,                  /* -msingle-float */
  OPT_msmartmips = 1071,                     /* -msmartmips */
  OPT_msoft_float = 1072,                    /* -msoft-float */
  OPT_msplit_addresses = 1073,               /* -msplit-addresses */
  OPT_msym32 = 1074,                         /* -msym32 */
  OPT_msynci = 1075,                         /* -msynci */
  OPT_mtune_ = 1076,                         /* -mtune= */
  OPT_muclibc = 1077,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1078,        /* -muninit-const-in-rodata */
  OPT_mvr4130_align = 1079,                  /* -mvr4130-align */
  OPT_mxgot = 1080,                          /* -mxgot */
  OPT_n = 1081,                              /* -n */
  OPT_no_canonical_prefixes = 1082,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1083,              /* -no-integrated-cpp */
  OPT_noasmopt = 1084,                       /* -noasmopt */
  OPT_nocpp = 1085,                          /* -nocpp */
  OPT_nodefaultlibs = 1086,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1087,                   /* -nostartfiles */
  OPT_nostdinc = 1088,                       /* -nostdinc */
  OPT_nostdinc__ = 1089,                     /* -nostdinc++ */
  OPT_nostdlib = 1090,                       /* -nostdlib */
  OPT_o = 1091,                              /* -o */
  OPT_p = 1092,                              /* -p */
  OPT_pass_exit_codes = 1093,                /* -pass-exit-codes */
  OPT_pedantic = 1094,                       /* -pedantic */
  OPT_pedantic_errors = 1095,                /* -pedantic-errors */
  OPT_pg = 1096,                             /* -pg */
  OPT_pie = 1097,                            /* -pie */
  OPT_pipe = 1098,                           /* -pipe */
  OPT_posix = 1099,                          /* -posix */
  OPT_print_file_name_ = 1100,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1101,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1102,          /* -print-multi-directory */
  OPT_print_multi_lib = 1103,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1104,       /* -print-multi-os-directory */
  ...
  /* OPT_std_c__03 = 1130, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1131, */                /* -std=c++0x */
  OPT_std_c__11 = 1132,                      /* -std=c++11 */
  ...
  OPT_time = 1163,                           /* -time */
  OPT_time_ = 1164,                          /* -time= */
  OPT_tno_android_cc = 1165,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1166,                 /* -tno-android-ld */
